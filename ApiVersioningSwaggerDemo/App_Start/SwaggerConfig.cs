...
using ApiVersioningSwaggerDemo;
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Api Versioning Swagger Demo")
                            .Description(ApiDescription)
                            .Contact(CB =>
                                CB.Name(ApiContactName)
                                    .Url(ApiContactUrl)
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        c.InjectStylesheet(thisAssembly, "ApiVersioningSwaggerDemo.Swagger.swaggerCustom.css");

                        // Use the "InjectJavaScript" option to invoke one or more custom JavaScripts after the swagger-ui
                        // has loaded. The file must be included in your project as an "Embedded Resource", and then the resource's
                        // "Logical Name" is passed to the method as shown above.
                        //
                        c.InjectJavaScript(thisAssembly, "ApiVersioningSwaggerDemo.Swagger.swaggerCustom.js");
